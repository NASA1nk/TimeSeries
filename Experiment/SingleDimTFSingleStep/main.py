...
def plot_loss(eval_model, val_data, scaler):
    ...
    ax.plot(predict-ground_truth, color="green", label="diff")
    ax.legend() 
    plt.savefig(f'./Experiment/SingleDimTFSingleStep/img/100_1_512_3_32/normal_Epoch_{epoch}.png')
...
if __name__ == "__main__":
    ...
    for epoch in range(1, epochs+1):
        ...
        scheduler.step()
    torch.save(best_model.state_dict(), f'./Experiment/SingleDimTFSingleStep/best_model/100_1_512_3_32.pth')
    e_time = time.time()
