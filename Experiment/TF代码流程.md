...
**原始数据集是一列数据**，处理原始数据集得到模型的训练集

- 每次从数据集中取出目标窗口（target_window = 100）长度的数据
  - 因为**预测步长（output_window = 1）是1**，所以数据集的(i,i+100)部分是输入，数据集的(i+1,i+100+1)部分是输出
  - 即训练集（是一个list）为：[([0-100],[1-101]),([1-101],[2-102])...]
...
**所以2000长度的数据，总共可以生成2000-100 = 1900个数据，每个数据中包含两个窗口的数据，各长100，即(1900,2,100)**
...
pe是5000个维度为d_model（250）的tensor，即**(5000,250)**
...
position则是5000个1维的tensor，即**(5000,1)**，用于给pe的每一个维度（250）填充值
...
**即5000个数据，每个数据是一个窗口，窗口内有一个长度是250维的窗口**
...
- 20个数据中，每个数据的**第一个列表数据item[0]是输入[0-100]**
- 20个数据中，每个数据的**第二个列表数据item[1]是输出[1-101]**
...
```json
// t = [item[0] for item in data]，即20个长度为100的tensor list
// torch.stack(inputs, dim=?)→Tensor，对inputs(多个tensor)沿指定维度dim拼接，返回一维的tensor
// x = torch.stack(t) 拼接t，获取tensor 
// x(20,100)
tensor([[-0.5161, -0.5684, -0.5169,  ..., -0.5884, -0.7686, -0.4507],
        [-0.5684, -0.5169, -0.6286,  ..., -0.7686, -0.4507, -0.5368],
        [-0.5169, -0.6286, -0.3985,  ..., -0.4507, -0.5368, -0.4574],
...
// y = torch.chunk(x,100,1)，input_window=100，在列上将x(20,100)分成100块，所以每一块有20个数据，即竖着切分，最后拼成一列
// y100长度的tuple，每个是一个(20,1)的tensor，即x的20行的一列数据
(tensor([[-0.5161],
        [-0.5684],
        [-0.5169],
        [-0.6286],
        ...
        [-0.8046],
        [-0.4976],
        [-0.8442]], device='cuda:0'), tensor([[-0.5684],
        [-0.5169],
        [-0.6286],
        [-0.3985],
        [-0.5671],
        ...
        [-0.4976],
        [-0.8442],
        [-0.6934]], device='cuda:0'), tensor([[-0.5169],
        [-0.6286],
        [-0.3985],
        [-0.5671],
        [-0.4416],
        ...
        [-0.8442],
        [-0.6934],
        [-0.8517]], device='cuda:0'), tensor([[-0.6286],
        [-0.3985],
        [-0.5671],
        [-0.4416],
        [-0.7152],
        ...
        [-0.6934],
        [-0.8517],
        [-0.7266]], device='cuda:0'), tensor([[-0.3985],
        [-0.5671],
        [-0.4416],
        [-0.7152],
        [-0.6121],
        ...
        [-0.8517],
        [-0.7266],
        [-0.5894]], device='cuda:0'), tensor([[-0.5671],
        [-0.4416],
        [-0.7152],
        [-0.6121],
        [-0.7587],
        ...
        [-0.7266],
        [-0.5894],
        [ 1.0000]], device='cuda:0'), tensor([[-0.4416],
        [-0.7152],
        [-0.6121],
        [-0.7587],
        [-0.5539],
        ...
        [-0.5894],
        [ 1.0000],
        [-0.4753]], device='cuda:0'), tensor([[-0.7152],
        [-0.6121],
        [-0.7587],
        [-0.5539],
        [-0.4342],
        ...
        [ 1.0000],
        [-0.4753],
        [-0.4870]], device='cuda:0'), tensor([[-0.6121],
        [-0.7587],
        [-0.5539],
        [-0.4342],
        [-0.2928],
        ...
        [-0.4753],
        [-0.4870],
        [-0.4651]], device='cuda:0'), tensor([[-0.7587],
        [-0.5539],
        [-0.4342],
        [-0.2928],
        [-0.2900],
        ...
        [-0.4870],
        [-0.4651],
        [-0.6508]], device='cuda:0'), tensor([[-0.5539],
        [-0.4342],
        [-0.2928],
        [-0.2900],
        [-0.6720],
        ...
        [-0.4651],
        [-0.6508],
        [-0.4771]], device='cuda:0'), tensor([[-0.4342],
        [-0.2928],
        [-0.2900],
        [-0.6720],
        [-0.7235],
        ...
        [-0.6508],
        [-0.4771],
        [-0.4479]], device='cuda:0'), tensor([[-0.2928],
        [-0.2900],
        [-0.6720],
        [-0.7235],
        [-0.8511],
        ...
        [-0.4771],
        [-0.4479],
        [-0.5342]], device='cuda:0'), tensor([[-0.2900],
        [-0.6720],
        [-0.7235],
        [-0.8511],
        [-0.8046],
...
最终转换为1列后，是**(100,20,1)**，就是输入到网络中的数据in
...
根据输入数据的规模**(100,20,1)**生成一个**上三角矩阵mask，(100,100)**

- 负无穷经过softmax后，权重就会接近0
...
- **最终输出一个(100,20,1)的数据**，这就是本次训练的结果
- 对应之前的out数据
