...
- 每次从数据集中取出目标窗口长度的数据（target_window = 100）
...
**所以2000长度的文件，总共可以生成2000-100 = 1900个数据，每个数据中包含两个窗口的数据，各长100，即(1900,2,100)**，然后减去预测窗口（output_target）大小，即1900-1=1899个数据，**(1899,2,100)**
